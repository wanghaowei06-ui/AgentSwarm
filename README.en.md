...
[English](./README.en.md) | [中文](./README.md) | [日本語](./README.ja-JP.md)
...
The current source-based competition snapshot is `competition-v1.1`. Judges should follow the [competition reproduction guide](docs/competition-reproduction.md), which builds the real AgentTeams images from the checked-out tag, configures a live LLM provider, starts the embedded deployment, and runs verification tests.
