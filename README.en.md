...
[![Competition snapshot](https://img.shields.io/badge/competition-v1.1-6f42c1.svg)](./docs/competition-reproduction.md)
...
The currently published snapshot is `competition-v1.1`. After this governance update is verified, the next immutable public version will be `competition-v1.2`; evaluators should use a fixed tag rather than the moving `main` branch.
...
- `competition-v1.1` is the previously published immutable competition snapshot.
